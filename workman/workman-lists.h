...
# define WORKMAN_TYPE_PLUGIN_LIST (workman_plugin_list_get_type())
# define WORKMAN_TYPE_OBJECT_LIST (workman_object_list_get_type())
...
GType workman_plugin_list_get_type(void) G_GNUC_CONST;
GType workman_object_list_get_type(void) G_GNUC_CONST;
